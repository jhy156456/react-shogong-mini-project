...
export default function Header(props) {
    ...
    const headerColorChange = () => {
        ...
        if (windowsScrollTop > changeColorOnScroll.height) {
            // console.log(  document.body.getElementsByTagName("header")[0]) console.log(
            // document.body.getElementsByTagName("header")[0].classList)
            // console.log(classes[color])   console.log(classes[changeColorOnScroll.color])
            // 변경상태
            document
                .body
            ...
            imageRef.current.style.color = "black"
        } else {
            //초기상태
            document
                .body
            ...
            imageRef.current.style.color = "white"
        }
    };
    const {
        color,
    ...
    const brandComponent = (
        ...
        // className={imageClasses} ref={imageRef}/></a>
    );
...
Header.propTypes = {
    ...
    // this will cause the sidebar to change the color from props.color (see above)
    // to changeColorOnScroll.color when the window.pageYOffset is heigher or equal
