  ...
  return (
    <>
      <Dialog
        ...
        keepMounted
        onClose={() => onClickClassicModal(false)}
      ...
      >
        ...
        >
          <ModalHeader>
            제1조(목적)
            <br />
            <ModalHeader>표준약관 제10023호</ModalHeader>
          </ModalHeader>
          <ModalContents>
            이 약관은 (주)쇼공 회사(전자거래 사업자)가 운영하는 쇼공 사이버
          ...
          <br />
          <ModalContents>
            ※ 「PC통신등을 이용하는 전자거래에 대해서도 그 성질에 반하지 않는한
            이 약관을 준용합니다」
          </ModalContents>
          <ModalHeader>제2조(정의)</ModalHeader>
          <ModalContents>
            ① "몰"이란 (주)쇼공 회사가 재화 또는 용역을 이용자에게 제공하기
          ...
          <ModalContents>
            ...
            <br />② "몰"은 이용자가 약관에 동의하기에 앞서 약관에 정하여져 있는
          ...
          <ModalHeader>제4조(서비스의 제공 및 변경)</ModalHeader>
          <ModalContents>
          ...
          <ModalHeader>제5조(서비스의 중단)</ModalHeader>
          <ModalContents>
            ...
            <br />③ 사업종목의 전환, 사업의 포기, 업체간의 통합 등의 이유로
          ...
          <ModalHeader>제6조(회원가입)</ModalHeader>
          <ModalContents>
            ...
            상실후 3년이 경과한 자로서 "몰"의 회원재가입 승낙을 얻은 경우에는
            예외로 한다.
            <br />
            ...
            현저히 지장이 있다고 판단되는 경우
            <br />③ 회원가입계약의 성립시기는 "몰"의 승낙이 회원에게 도달한
            시점으로 합니다.
            <br />④ 회원은 제15조제1항에 의한 등록사항에 변경이 있는 경우, 즉시
            전자우편 기타 방법으로 "몰"에 대하여 그 변경사항을 알려야 합니다.
          </ModalContents>
          <ModalHeader>제7조(회원 탈퇴 및 자격 상실 등)</ModalHeader>
          <ModalContents>
            ① 회원은 "몰"에 언제든지 탈퇴를 요청할 수 있으며 "몰"은 즉시
            회원탈퇴를 처리합니다.
            <br />② 회원이 다음 각호의 사유에 해당하는 경우, "몰"은 회원자격을
            제한 및 정지시킬 수 있습니다.
            <br />
            ...
            이 경우 회원에게 이를 통지하고, 회원등록 말소전에 최소한 30일 이상의
            기간을 정하여 소명할 기회를 부여합니다.
          </ModalContents>
          <ModalHeader>제8조(회원에 대한 통지)</ModalHeader>
          <ModalContents>
            ...
            개별통지를 합니다.
            <br />③ 신규 회원의 전화번호수집 양식 및 기존 회원 대상의 공지
            이메일 등을 통해 안내 주문, 배송 정보 등 비광고성 정보를 카카오톡
            알림톡으로 알려드리며, 브이리뷰 챗봇을 통하여 리뷰에 관한 사항을
            안내해드립니다. 만약 알림톡 수신이 불가능하거나 수신 차단하신
            경우에는 일반 문자 메시지로 보내드립니다. 와이파이 아닌
            이동통신망으로 접속시 알림톡 수신 중 데이터요금이 발생할 수
            있습니다. 알림톡과는 다른 방식으로 정보 수신을 원하시거나 챗봇을
            수신하기 원하지 않으시면 알림톡과 챗봇을 차단해주세요.
          </ModalContents>
          <ModalHeader>제9조(구매신청)</ModalHeader>
          <ModalContents>
          ...
          <ModalHeader>제10조 (계약의 성립)</ModalHeader>
          <ModalContents>
          ...
          <ModalHeader>제11조(지급방법)</ModalHeader>
          <ModalContents>
          ...
          <ModalHeader>제12조(수신확인통지·구매신청 변경 및 취소)</ModalHeader>
          <ModalContents>
          ...
          <ModalHeader>제13조(재화등의 공급)</ModalHeader>
          <ModalContents>
          ...
          <ModalHeader>제14조(환급)</ModalHeader>
          <ModalContents>
          ...
          <ModalHeader>제15조(청약철회 등)</ModalHeader>
          <ModalContents>
            ...
            훼손된 경우(다만, 재화 등의 내용을 확인하기 위하여 포장 등을 훼손한
            경우에는 청약철회를 할 수 있습니다)
            <br />
          ...
          <ModalHeader>제16조(청약철회 등의 효과)</ModalHeader>
          <ModalContents>
            ...
            이용자가 부담합니다. "몰"은 이용자에게 청약철회등을 이유로 위약금
            또는 손해배상을 청구하지 않습니다. 다만 재화등의 내용이 표시·광고
          ...
          <ModalHeader>제17조(개인정보보호)</ModalHeader>
          <ModalContents>
            ...
            열람 및 오류정정을 요구할 수 있으며 "몰"은 이에 대해 지체없이 필요한
          ...
          <ModalHeader>제18조(“몰“의 의무)</ModalHeader>
          <ModalContents>
          ...
          <ModalHeader>제19조(회원의 ID 및 비밀번호에 대한 의무)</ModalHeader>
          <ModalContents>
          ...
          <ModalHeader>제20조(이용자의 의무)</ModalHeader>
          <ModalContents>
          ...
          <ModalHeader>제21조(연결"몰"과 피연결"몰" 간의 관계)</ModalHeader>
          <ModalContents>
          ...
          <ModalHeader>제22조(저작권의 귀속 및 이용제한)</ModalHeader>
          <ModalContents>
          ...
          <ModalHeader>제23조(분쟁해결)</ModalHeader>
          <ModalContents>
            ① "몰"은이용자가 제기하는 정당한 의견이나 불만을 반영하고 그 피해를
          ...
          <ModalHeader>제24조(재판권 및 준거법)</ModalHeader>
          <ModalContents>
          ...
          <ModalHeader>개인정보수집 동의항목 설정</ModalHeader>
          <ModalContents>
            1. 이용자 식별 및 본인여부 확인
            <br />
            &nbsp;&nbsp;&nbsp;- 항목 : 이름, 아이디, 비밀번호
        ...
        <DialogActions className={classes.modalFooter}>
          ...
          <Button onClick={() => onClickClassicModal(false)} color="danger" simple>
            Close
          </Button>
        </DialogActions>
      </Dialog>
